...
SECRET_KEY = 'django-insecure-@@s+jg%t=9)nftf_1asp%sgh9j#tf(_vtlx-fgyih^@=yy1((u'
...
DATABASES = {
    "default": {
        ...
        "NAME": env("POSTGRES_CONTROL_DB", default="cmms_control"),
        "USER": env("POSTGRES_CONTROL_USER", default="cmms_user"),
